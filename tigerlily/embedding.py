...
class EmbeddingMachine:
    ...
    def generate_mappings(self, pagerank_scores):
        ...
        mat = coo_matrix((pagerank_scores["score"], (pagerank_scores["node_1_num"], pagerank_scores["node_2_num"])),
    ...
    def fit(self, pagerank_scores: pd.DataFrame):
        ...
        pagerank_scores = pagerank_scores[["node_1","node_1_num"]].drop_duplicates(ignore_index=True).sort_values("node_1_num")
